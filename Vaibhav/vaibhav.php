...
foreach($apiResponse as $key => $value) {
      if(str_contains($value, "!!Error!!")){
        ...
        header("refresh:5; URL=http://localhost/payu/PHP_Kit/Vaibhav/PaymentServiceApp/error.html");
        exit();
      }
   }
...
echo "<B>Customer Lastname: </B>".$brespLastname;
echo "<br>";
...
echo "<B>Amount: </B>".$brespAmount;
echo "<br>";


echo "<B>Process ID: </B>".$brespPID;
echo "<br>";


echo "<B>Bank Vrification Status: </B>".$brespVerify;
echo "<br>";


echo "<B>Bank Code: </B>".$brespBankCode;
echo "<br>";


echo "<B>Bank Name: </B>".$brespBankName;
echo "<br>";

echo "<B>Bank Branch: </B>".$brespBranchCode;
echo "<br>";


echo "<B>Currency: </B>".$brespCurrency;
echo "<br>";


echo "<B>Phone: </B>".$brespPhone;
echo "<br>";


echo "<B>Email ID: </B>".$brespEmail;
echo "<br>";
...
if($brespTxnID == $resptransactionid && $brespUVR == $respuvr ){
  //Success
  //sleep(seconds)
  header("refresh:5; URL=http://localhost/payu/PHP_Kit/Vaibhav/PaymentServiceApp/success.html");
  exit();
}else{
  ...
  header("refresh:5; URL=http://localhost/payu/PHP_Kit/Vaibhav/PaymentServiceApp/failed.html");
  exit();
}
